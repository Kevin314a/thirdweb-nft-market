...
export const SwapPanel = () => {
  return (
    <div className="block mx-auto">
      <div className="block min-w-[400px] max-w-[400px] md:min-w-[720px] md:max-w-[720px] min-h-[200px] max-h-[200px] md:min-h-[360px] md:max-h-[360px] bg-[#846a51] rounded-2xl backdrop-blur-[8px] py-2 px-2 md:px-4">
        ...
        <div className="stacking-approve-box bg-[#100e0e] overflow-hidden rounded-lg md:rounded-2xl">
          <div className="stacking-approve-box-minibox flex flex-row items-center justify-between md:gap-8 md:py-4 md:px-3 p-1">
            ...
            <input
              ...
              className="text-sm md:text-lg text-white !text-end md:w-[300px] w-[150px] bg-transparent !outline-none"
