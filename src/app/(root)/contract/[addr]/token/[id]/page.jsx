          ...
          <div className="flex lg:flex-nowrap flex-wrap justify-center gap-6">
            ...
            <div className="lg:w-[62%] md:w-1/2 w-full">
              <div className="w-full flex flex-col">
                ...
                <span className="mt-2 text-white text-2xl font-bold">{'Posse #3312'}</span>
                <span className="mt-2 text-golden-1000 text-sm">{'Posse NFTs are a collection of 3,000 unique characters designed for adventure and exclusive benefits. Owning one grants you reduced service fees, special discounts on future drops, early access to new features, and the ability to stake them in the service fee pool.'}</span>
